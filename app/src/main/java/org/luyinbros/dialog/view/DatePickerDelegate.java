...
public class DatePickerDelegate extends DatePickerDialog {
    private CompatDatePickerDialog mDelegateDialog;

    public void setDelegateDialog(CompatDatePickerDialog delegateDialog) {
        this.mDelegateDialog = delegateDialog;
    }

    @Override
    public void dismiss() {
        if (mDelegateDialog != null) {
    ...
    public void dismissAllowingStateLoss() {
        if (mDelegateDialog != null) {
            mDelegateDialog.dismissAllowingStateLoss();
        } else {
            super.dismissAllowingStateLoss();
        }
    }

    public static class CompatDatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController {
        ...
        private DatePickerDialog.Version mVersion;
         ...
         */
        public static CompatDatePickerDialog newInstance(DatePickerDialog.OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
            CompatDatePickerDialog ret = new CompatDatePickerDialog();
        ...
        public static CompatDatePickerDialog newInstance(DatePickerDialog.OnDateSetListener callback) {
            Calendar now = Calendar.getInstance();
            return CompatDatePickerDialog.newInstance(callback, now);
        }
         ...
         */
        @SuppressWarnings("unused")
        public static CompatDatePickerDialog newInstance(DatePickerDialog.OnDateSetListener callback, Calendar initialSelection) {
            CompatDatePickerDialog ret = new CompatDatePickerDialog();
            ret.initialize(callback, initialSelection);
            return ret;
        }

        public void initialize(DatePickerDialog.OnDateSetListener callBack, Calendar initialSelection) {
            mCallBack = callBack;
            ...
            mVersion = Build.VERSION.SDK_INT < Build.VERSION_CODES.M ? DatePickerDialog.Version.VERSION_1 : DatePickerDialog.Version.VERSION_2;
        }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (mScrollOrientation == null) {
                mScrollOrientation = mVersion == DatePickerDialog.Version.VERSION_1
            ...
            if (savedInstanceState != null) {
                ...
                mVersion = (DatePickerDialog.Version) savedInstanceState.getSerializable(KEY_VERSION);
                mScrollOrientation = (DatePickerDialog.ScrollOrientation) savedInstanceState.getSerializable(KEY_SCROLL_ORIENTATION);
            ...
            int viewRes = mVersion == DatePickerDialog.Version.VERSION_1 ? R.layout.mdtp_date_picker_dialog : R.layout.mdtp_date_picker_dialog_v2;
        ...
        private void setCurrentView(final int viewIndex) {
            ...
            switch (viewIndex) {
                case MONTH_AND_DAY_VIEW:
                    if (mVersion == DatePickerDialog.Version.VERSION_1) {
        ...
        private void updateDisplay(boolean announce) {
            ...
            if (mVersion == DatePickerDialog.Version.VERSION_2) {
         ...
         */
        public void setScrollOrientation(DatePickerDialog.ScrollOrientation orientation) {
        ...
        public void notifyOnDateListener() {
            if (mCallBack != null) {
                DatePickerDelegate delegate = new DatePickerDelegate();
                delegate.setDelegateDialog(this);
                mCallBack.onDateSet(delegate, mCalendar.get(Calendar.YEAR),
    ...
    static class DefaultDateRangeLimiter implements DateRangeLimiter {
